	...
	var dhtmlgoodies_menu_arrow = 'http://nts.iptime.org/layouts/test/images/arrow.gif';
	...
	function getTopPos(inputObj)
	{
	  ...
	  while(((inputObj = inputObj.offsetParent) != null)&&(inputObj.id != 'dhtmlgoodies_menu'))returnValue += inputObj.offsetTop;
...
*/
	...
	{
	  var returnValue = inputObj.offsetLeft;
	  while(((inputObj = inputObj.offsetParent) != null)&&(inputObj.id != 'dhtmlgoodies_menu')){returnValue += inputObj.offsetLeft; }
	  return returnValue;
	}
			...
			while(li){
				if(li.tagName=='LI'){	
					...
					if(MSIE){
						...
						a.style.width=li.offsetWidth-fact+'px';
