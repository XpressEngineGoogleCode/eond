	...
	var dhtmlgoodies_menu_arrow = 'http://nts.iptime.org/layouts/zero_menu/images/arrow.gif';
...
*/
	...
	{
		var returnValue = inputObj.offsetLeft;
		while((inputObj.id != 'gnb')&&((inputObj = inputObj.offsetParent)!=0)){returnValue += inputObj.offsetLeft;inputObj = inputObj.offsetParent;}
		return returnValue;
	}
	...
	*/
	...
	{
		dhtmlgoodies_menuObj = document.getElementById('gnb');
