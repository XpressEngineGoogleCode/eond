/************************************************************************************************************
	...
	************************************************************************************************************/
	...
	var timeBeforeAutoHide = 200; // Microseconds from mouse leaves menu to auto hide.
	var dhtmlgoodies_menu_arrow = './layouts/List based DHTML menu/images/arrow.gif';
	...
	{
		menuActive = true; //마우스를 땠을 때 레이어 사라지지 않음 true, 사라짐 false(기본값)
		timerAutoHide();
	}
